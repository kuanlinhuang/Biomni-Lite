# Biomni-Lite: Data lake files available on-demand from Zenodo.
# Files are NOT downloaded automatically on init. The agent downloads only what it needs.
ZENODO_RECORD_ID = "18759554"
